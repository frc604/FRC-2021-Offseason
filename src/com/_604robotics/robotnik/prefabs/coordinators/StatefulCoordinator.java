...
public class StatefulCoordinator extends Coordinator {
  ...
  public StatefulCoordinator addState(String name, Coordinator coordinator) {
    states.add(new Pair<>(name, coordinator));
    return this;
  }

  public StatefulCoordinator addState(Class<?> klass, Coordinator coordinator) {
