...
public class Robot extends TimedRobot {
  ...
  private Coordinator disabledMode;
  ...
  protected <T extends Coordinator> T setDisabledMode(T disabledMode) {
  ...
  public void disabledInit() {
    // This is called once when the robot enters disabled mode
    System.out.println("DISABLED_INIT");
    loopEnd(currentModeName, currentMode);
    currentMode = null;
    currentModeName = null;
    loopInit("Disabled", disabledMode);
  }

  @Override
  public void disabledPeriodic() {
    // This is called periodically while the robot is in disabled mode
    loopExecute("Disabled", disabledMode);
  }
